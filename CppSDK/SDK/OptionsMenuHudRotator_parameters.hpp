...
public:
	...
	struct FGameplayTag                           Gameplay_Tag_0;                                    // 0x0004(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(OptionsMenuHudRotator_C_Selection_Changed__DelegateSignature, Gameplay_Tag_0) == 0x000004, "Member 'OptionsMenuHudRotator_C_Selection_Changed__DelegateSignature::Gameplay_Tag_0' has a wrong offset!");
