...
void UPieChartRowWidget_C::Setup(int32 Num_0, const class FText& Name_0, float Value_0, ECommonNumericType NumericType, const struct FLinearColor& LegendColor)
{
